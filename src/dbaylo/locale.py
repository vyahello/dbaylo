...
START_TEXT = (
    "Привіт! Я Дбайло — твій друг, який розуміється на здоров'ї і завжди на твоєму боці. 🌿\n\n"
    "Розповідай, як почуваєшся, кидай аналізи — я допоможу розібратися, підкажу й нагадаю, "
    "коли треба. Без зайвої серйозності, але чесно.\n\n"
    f"{DISCLAIMER}\n\n"
