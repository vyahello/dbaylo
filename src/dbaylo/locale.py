...
CHART_PDF_NUMERIC_LINE = "На графіках — {n} показників із числовою динамікою"
CHART_PDF_CATEGORY_ROW = "{name} — {n}"  # one category line on the cover, e.g. "Аналіз крові — 10"
...
CHART_PDF_QUAL_NOTE = (
    "Ще {n} якісних показників (як-от «не виявлені») — їхню динаміку показано словами наприкінці."
)
CHART_PDF_SINGLE_NOTE = (
    "{n} показників мають поки лише один вимір — для графіка потрібно щонайменше два."
)
